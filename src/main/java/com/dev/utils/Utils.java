...
public class Utils {
    ...
    public static boolean todayDateAfter(LocalDate otherDate){
        LocalDate todayDate = LocalDate.now();
        return todayDate.isAfter(otherDate);
    }

    public static boolean todayDateBefore(LocalDate otherDate){
        LocalDate todayDate = LocalDate.now();
        return todayDate.isBefore(otherDate);
    }
